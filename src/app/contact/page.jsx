                    ...
                    <div className={'container'}>
                        <div className={'cd-card-list'}>
                            <div className={'cd-card'}>
                                ...
                                <p className={'h3'}>+91 98765 43210</p>
                                <small>[ Mon - Sat: 9:00 AM – 7:00 PM ]</small>
                                <div className={'cd-icon'}>
                                    <svg width="25" height="24" viewBox="0 0 25 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_84_1373)">
                                            <path
                            ...
                            <div className={'cd-card'}>
                                ...
                                <p className={'h6'}>info@thermwinsystemwindows.com</p>
                                <div className={'cd-icon'}>
                                    <svg width="25" height="24" viewBox="0 0 25 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className={'row'}>
                            ...
                            <div className={'col-md-12'}>
                                <div className={'form-group mb-3'}>
                                    ...
                                    <textarea className={'form-control'} placeholder={'Type here'} rows={'4'}/>
                                </div>
                            </div>
                            <div className={'col-md-12'}>
                                <div className={'form-group mb-3'}>
                                    <button className={'btn btn-default w-100'}><span className={'py-3'}>Submit</span></button>
                                </div>
                            </div>
                        </div>
                    </div>
